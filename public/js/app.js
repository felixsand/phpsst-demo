...
var phpsst = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#phpsst',
    data: {
        errorMsg: '',
        passwordDisplay: '',
    ...
    methods: {
        ...
        storeSecret: function storeSecret() {
            this.errorMsg = '';
        ...
        checkForSecretKeys: function checkForSecretKeys() {
        ...
        showUrl: function showUrl(key) {
            this.secretUrl = window.location.protocol + '//' + window.location.host + window.location.pathname + '#' + key;
        ...
        getDaysLabel: function getDaysLabel(day) {
            var label = day + ' day';
            if (day > 1) {
                label += 's';
            }
        ...
        getHoursLabel: function getHoursLabel(hour) {
            var label = hour + ' hour';
            if (hour > 1) {
                label += 's';
            }
        ...
        getViewsLabel: function getViewsLabel(view) {
            var label = view + ' view';
            if (view > 1) {
                label += 's';
            }
